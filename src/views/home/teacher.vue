<template>
  ...
  <div style="background: #eee">
    ...
    <div class="teacher-info">
      <div class="ti-base">
        ...
        <div>
          ...
          <p>
            <font v-if="tc_obj.teacher.sex == 0">男</font
            ><font v-if="tc_obj.teacher.sex == 1">女</font>&emsp;教龄{{
              tc_obj.teacher.teach_age
            }}
          </p>
        </div>
    ...
    <div class="btn" @click="$router.push(`/oto-plan?id=${id}`)">
      <span>立即预约</span>
    </div>
  </div>
</template>
